    ...
    try {
        ...
        if (interaction.isCommand()) {
            ...
            if (commandName === 'play') {
                ...
                return interaction.reply({ content: `Play request for ${game} has been created!`, ephemeral: true });
            ...
            if (action === 'accept') {
                ...
                const bannedUsers = readBannedUsers();
                if (!bannedUsers.includes(interaction.customId.replace('ban_', ''))) {
                    bannedUsers.push(interaction.customId.replace('ban_', ''));
                    writeBannedUsers(bannedUsers);
