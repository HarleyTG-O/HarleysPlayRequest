    ...
    try {
        ...
        if (interaction.isCommand()) {
            ...
            if (commandName === 'playend') {
                ...
                if (playRequest.userId !== interaction.user.id) {
                    return interaction.reply({ content: 'You are not the requester of this play request!', ephemeral: true });
                }

                playRequests.delete(playRequestId);
                writePlayRequests(playRequests);

                await interaction.reply('Play request has been ended.');
            }
            ...
            if (commandName === 'ban') {
                ...
                if (!bannedUsers.includes(user.id)) {
                    ...
                    await interaction.reply(`User ${user.tag} has been banned for: ${reason}`);
                } else {
        ...
        if (interaction.isButton()) {
            ...
            if (action === 'accept') {
                ...
                // Optionally update message and button state here
            }
